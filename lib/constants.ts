...
export const PRICING = [
  {
    ...
    featured: false,
    features: [
      "Landing page sau site de prezentare (1-4 pagini)",
  ...
  },
  {
    ...
    price: "de la 399 EUR",
    subtitle: "(~1.995 RON)",
    monthlyFrom: "sau de la ~33 EUR/lună",
    featured: true,
    badge: "Cel mai avantajos",
    features: [
      "Site complet, 5-10 pagini",
      "Pagină separată pentru fiecare serviciu",
      "Blog sau secțiune de articole",
      "Optimizare SEO pe fiecare pagină",
  ...
  },
  {
    ...
    price: "de la 699 EUR",
    subtitle: "(~3.495 RON)",
    monthlyFrom: "sau de la ~58 EUR/lună",
    featured: false,
    features: [
