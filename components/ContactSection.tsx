            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-base leading-relaxed" style={{ color: "var(--color-text-muted)" }}>
                  Completează formularul sau contactează-mă direct. Răspund în maximum
                  24 de ore.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <a
                  href="mailto:aiwant.automation@gmail.com"
          ...
          <ScrollReveal delay={0.15}>
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl font-semibold text-white transition-all duration-200 hover:scale-[1.02] disabled:opacity-60 disabled:scale-100 focus-visible:outline-none gold-glow-hover"
