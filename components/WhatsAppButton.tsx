    ...
    <AnimatePresence>
      {mounted && (
        <motion.div
          ...
          initial={{ scale: 0 }}
          animate={{ scale: wiggle ? [1, 1.05, 0.97, 1.03, 1] : 1 }}
          exit={{ scale: 0 }}
          transition={
            wiggle
        ...
        >
          ...
          <a
            ...
            className="group flex items-center justify-center rounded-full shadow-lg transition-all duration-200 hover:scale-110 md:w-14 md:h-14 w-12 h-12"
            style={{
              background: "#25D366",
